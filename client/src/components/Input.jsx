...
const Input = () => {
    ...
    return (
        <div className='flex justify-center items-center'>
            <form onSubmit={(e) => handleSubmit(e)} className="flex h-20 md:h-16 mb-10 w-full max-w-[700px] items-center gap-2 overflow-hidden rounded-full border border-[#4A4E69] bg-white">
                ...
                <button type="submit" className="mr-2 h-13 w-56 rounded-full bg-[#22223B] text-sm text-white transition active:scale-95 cursor-pointer "><span className='text-2xl'>Shorten</span></button>
            </form>
        </div>
    )
}
